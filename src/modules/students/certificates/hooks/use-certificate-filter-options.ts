...
/**
 * Class/section options for the certificate filter, mirroring the same
 * endpoints and session-scoping the homework/lesson-plan filter bars use —
 * classes and sections are separate entities in this schema, never embedded
 * on the class record itself.
 */
