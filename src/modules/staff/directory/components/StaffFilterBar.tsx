...
import { StaffFilter } from "./StaffList";
...
export default function StaffFilterBar({ children, filter, setFilter }: Props) {
	const { data: designationResponse } = useSWR("/designations/active-list", { type: "staff" });
